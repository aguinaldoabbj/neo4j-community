...
echo "dbms.security.procedures.unrestricted=apoc.*,algo.*" >> $NEO4J_HOME/conf/neo4j.conf
echo "dbms.security.procedures.whitelist=apoc.*, algo.*" >> $NEO4J_HOME/conf/neo4j.conf
